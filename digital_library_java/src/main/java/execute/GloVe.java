...
import objects.OrderedIntegerPair;
...
public class GloVe {
    ...
    private static Logger _logger = Logger.getLogger(GloVe.class.getName());
    ...
    public static List<Cooccurrence> build_cooccurrence(Vocabulary vocab, String corpusFile, Options options) {
        ...
        List<Cooccurrence> coocurrences = new ArrayList<Cooccurrence>();
