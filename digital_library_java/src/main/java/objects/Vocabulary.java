...
public class Vocabulary {
    ...
    public Vocabulary() {
        word2id = new HashMap<String, Integer>(5000);
        id2word = new HashMap<Integer, String>(5000);
        wordFreqs = new HashMap<String, Integer>(5000);
    }


    public Vocabulary(int initialCapacity) {
        word2id = new HashMap<String, Integer>(initialCapacity);
        id2word = new HashMap<Integer, String>(initialCapacity);
        wordFreqs = new HashMap<String, Integer>(initialCapacity);
    }
