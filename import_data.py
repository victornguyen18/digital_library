...
file_title = open(filename_title, 'r', encoding="utf8")
...
file_books = open(filename_books, 'r', encoding="utf8")
...
file_transactions = open(filename_transactions, 'r', encoding="utf8")
